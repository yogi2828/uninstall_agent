...
// 2. Request App Uninstallation & Generate Magic Email Link
app.post('/api/uninstall/request', (req, res) => {
  ...
  // Create JWT Signed Token (Valid for 24 hours)
...
// 3. Web Trigger Link Handler (Simulates user clicking email link in browser)
app.get('/api/uninstall/trigger-web', (req, res) => {
...
// 4. Verify Token Endpoint (Called by Client Desktop Agent)
app.get('/api/uninstall/verify', (req, res) => {
...
// 5. Progress Report Endpoint (Called by Client Desktop Agent)
app.post('/api/uninstall/report', (req, res) => {
